...
| Inference Comparison (PASS) | 2110 | 91.5% | 93.3% |
## Fail Summary
...
| model--bart-base-few-shot-k-16-finetuned-squad-seed-4--anas-awadalla | Numerics | None | |
...
| model--bert-base-uncased-few-shot-k-64-finetuned-squad-seed-4--anas-awadalla | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--geniusguy777 | Numerics | None | |
...
| model--marian-finetuned-kde4-cs2sv--ksaml | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--Abelll | Numerics | None | |
