...
|---|---|---|---|---|---|---|
|migraphx_torchvision__inceptioni32|PASS|progression|6648.7116|19.6937|-6629.0179|-99.7%|
|migraphx_torchvision__resnet50i64|PASS|progression|6088.0794|14.8893|-6073.1901|-99.76%|
...
|model--bert-base-uncased-finetuned-squad-frozen-v2--ericRosello|PASS|Numerics|
|model--bert-finetuned-ner--brjezierski|PASS|Numerics|
|model--bert-finetuned-ner--yinxiaoz|PASS|Numerics|
|model--bert-finetuned-squad--JWP|PASS|Numerics|
|model--bert-finetuned-squad--RyanM-R|PASS|Numerics|
|model--bert-finetuned-squad--jaese|PASS|Numerics|
|model--bert-finetuned-squad--joe138138|PASS|Numerics|
|model--bert-finetuned-squad--yaozeguo|PASS|Numerics|
|model--bert-finetuned-squad_one_epoch--jedstrom|PASS|Numerics|
...
|model--marian-finetuned-kde4-en-to-fr--sofa566|PASS|Numerics|
|model--marian-finetuned-kde4-en-to-vi--huynguyen208|PASS|Numerics|
|model--marian-finetuned-kde4-en-to-zh_TW--peterhsu|PASS|Numerics|
|model--pegasus-xsum--google|PASS|Numerics|
|model--spanbert-base-cased-few-shot-k-512-finetuned-squad-seed-2--anas-awadalla|PASS|Numerics|
