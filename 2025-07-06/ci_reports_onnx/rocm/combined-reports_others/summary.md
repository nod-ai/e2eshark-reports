...
| Inference Comparison (PASS) | 2249 | 95.3% | 97.1% |
## Fail Summary
...
| model--bert-base-uncased-finetuned-squad-frozen-v2--ericRosello | Numerics | None | |
...
| model--bert-finetuned-ner--brjezierski | Numerics | None | |
...
| model--bert-finetuned-squad--JWP | Numerics | None | |
...
| model--bert-finetuned-squad--joe138138 | Numerics | None | |
...
| model--bert-finetuned-squad_one_epoch--jedstrom | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--sofa566 | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-vi--huynguyen208 | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-zh_TW--peterhsu | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-512-finetuned-squad-seed-2--anas-awadalla | Numerics | None | |
...
| tf_efficientnet_l2_ns_Opset16_timm | Numerics | None | |
