...
| IREE Compilation | 2280 | 98.9% | 99.1% |
| Gold Inference | 2280 | 98.9% | 100.0% |
| IREE Inference Invocation | 2278 | 98.8% | 99.9% |
| Inference Comparison (PASS) | 2068 | 89.7% | 90.8% |
## Fail Summary
...
|--|--|--|
| Setup | 4 | 0.2% |
| IREE Compilation | 21 | 0.9% |
| Gold Inference | 0 | 0.0% |
| IREE Inference Invocation | 2 | 0.1% |
| Inference Comparison | 210 | 9.1% |
## Test Run Detail
...
| model--MTL-bert-base-uncased-ww-squad--jgammack | Numerics | None | |
| model--MTL-distilbert-base-uncased-squad--jgammack | PASS | None | |
| model--MetaQA--haritzpuerto | Numerics | None | |
...
| model--bert-base-cased-finetuned-squad--Seongkyu | Numerics | None | |
...
| model--bert-base-uncased-finetuned-squad--harveyagraphcore | Numerics | None | |
...
| model--bert-finetuned-ner--Hasanmurad | Numerics | None | |
...
| model--bert-finetuned-ner--JAS100 | Numerics | None | |
...
| model--bert-finetuned-ner--amartyobanerjee | Numerics | None | |
...
| model--bert-finetuned-ner--mxalmeida | Numerics | None | |
...
| model--bert-finetuned-ner--suonbo | Numerics | None | |
...
| model--bert-finetuned-ner--tomjam | Numerics | None | |
...
| model--bert-finetuned-ner--yixi | Numerics | None | |
...
| model--bert-finetuned-squad--Asmit | Numerics | None | |
...
| model--bert-finetuned-squad--Dylan1999 | Numerics | None | |
...
| model--bert-finetuned-squad--OMEGAROFLING | Numerics | None | |
| model--bert-finetuned-squad--Petros89 | PASS | None | |
| model--bert-finetuned-squad--Pranath | Numerics | None | |
...
| model--bert-finetuned-squad--TheWayEX | Numerics | None | |
...
| model--bert-finetuned-squad--bbbbearczx | Numerics | None | |
...
| model--bert-finetuned-squad--jfarmerphd | Numerics | None | |
| model--bert-finetuned-squad--jmoraes | Numerics | None | |
...
| model--bert-finetuned-squad--nickong | Numerics | None | |
...
| model--bert-finetuned-squad--spasis | Numerics | None | |
...
| model--bert-finetuned-squad-legalbert--Jasu | Numerics | None | |
...
| model--bert-large-NER--51la5 | Numerics | None | |
...
| model--distilbert-base-cased-finetuned-conll03-english--elastic | Numerics | None | |
...
| model--distilbert-base-uncased-finetuned-squad--emre | Numerics | None | |
...
| model--distilbert-base-uncased-finetuned-squad--gudjonk93 | Numerics | None | |
...
| model--distilbert-base-uncased-finetuned-squad--kenlevine | Numerics | None | |
...
| model--finetuning-movie-sentiment-model-9000-samples--Manishkalra | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--Hackerino | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--KarimKhalil | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--PeterKh | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--csam | Numerics | None | |
...
| model--first_finetuning-sentiment-model-3000-samples--Positroniy | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--miesnerjacob | Numerics | None | |
| model--marian-finetuned-kde4-en-to-fr--mrp | PASS | None | |
| model--marian-finetuned-kde4-en-to-fr--mxalmeida | Numerics | None | |
...
| model--my_awesome_qa_model--satyamverma | Numerics | None | |
...
| model--sentiment-model-sample--jkhan447 | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-16-finetuned-squad-seed-8--anas-awadalla | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-32-finetuned-squad-seed-2--anas-awadalla | Numerics | None | |
