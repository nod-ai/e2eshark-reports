...
| IREE Compilation | 2327 | 98.6% | 98.6% |
| Gold Inference | 2327 | 98.6% | 100.0% |
| IREE Inference Invocation | 2325 | 98.5% | 99.9% |
| Inference Comparison (PASS) | 1344 | 56.9% | 57.8% |
## Fail Summary
...
|--|--|--|
| Setup | 2 | 0.1% |
| IREE Compilation | 32 | 1.4% |
| Gold Inference | 0 | 0.0% |
| IREE Inference Invocation | 2 | 0.1% |
| Inference Comparison | 981 | 41.6% |
## Test Run Detail
...
| model--Bert_Squad--johnjose223 | Numerics | None | |
...
| model--bert-base-multilingual-cased-finetuned-squad--Paul-Vinh | Numerics | None | |
...
| model--bert-finetuned-ner--mmibrahim2006 | Numerics | None | |
...
| model--bert-finetuned-squad--shafa | Numerics | None | |
...
| model--distilbart-xsum-12-6--sshleifer | Numerics | None | |
...
| model--distilbert-base-squad-TFM_1-Question-Answering--JoelVIU | Numerics | None | |
...
| model--finetuning-sentiment-model--abhijithsraj | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--Percival | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--Eitanli | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--clboetticher | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--ttri-pruiu | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-512-finetuned-squad-seed-0--anas-awadalla | Numerics | None | |
...
| efficientnet_em_Opset17_timm | Numerics | None | |
...
| ens_adv_inception_resnet_v2_Opset16_timm | Numerics | None | |
...
| pit_xs_224_Opset17_timm | Numerics | None | |
...
| poolformer_m48_Opset17_timm | Numerics | None | |
...
| regnetx_160_Opset18_timm | Numerics | None | |
...
| vgg19_bn_Opset17_torch_hub | Numerics | None | |
