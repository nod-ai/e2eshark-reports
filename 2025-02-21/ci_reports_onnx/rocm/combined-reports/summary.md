...
| IREE Inference Invocation | 2197 | 95.3% | 99.9% |
| Inference Comparison (PASS) | 2001 | 86.8% | 91.1% |
## Fail Summary
...
| swin_large_patch4_window12_384.ms_in22k_ft_in1k | Numerics | None | |
...
| model--bert-base-uncased-few-shot-k-32-finetuned-squad-seed-10--anas-awadalla | Numerics | None | |
...
| model--bert-cased-ner-fcit499--Ahmed87 | Numerics | None | |
| model--bert-engonly-sentiment-test--SiddharthaM | Numerics | None | |
...
| model--bert-finetuned-ner--Binaryy | Numerics | None | |
| model--bert-finetuned-ner--Buntan | PASS | None | |
| model--bert-finetuned-ner--CDRI-Eddy | Numerics | None | |
...
| model--bert-finetuned-ner--Laure996 | Numerics | None | |
...
| model--bert-finetuned-ner--amir36 | Numerics | None | |
...
| model--bert-finetuned-ner--buehlpa | Numerics | None | |
...
| model--bert-finetuned-ner--mholi | Numerics | None | |
...
| model--bert-finetuned-squad--Lexie79 | Numerics | None | |
| model--bert-finetuned-squad--Liyannnn | PASS | None | |
| model--bert-finetuned-squad--MarcusLee | Numerics | None | |
...
| model--bert-finetuned-squad--ZoeDuan | Numerics | None | |
...
| model--bert-finetuned-squad--algoprivacy | Numerics | None | |
| model--bert-finetuned-squad--alvin0220 | PASS | None | |
| model--bert-finetuned-squad--alvintu | PASS | None | |
| model--bert-finetuned-squad--amartyobanerjee | Numerics | None | |
| model--bert-finetuned-squad--andrew234 | PASS | None | |
| model--bert-finetuned-squad--ankitkupadhyay | Numerics | None | |
| model--bert-finetuned-squad--apatidar0 | Numerics | None | |
...
| model--bert-finetuned-squad--jaese | Numerics | None | |
...
| model--distillbert-base-uncased-fine-tuned-squadv2--monakth | Numerics | None | |
...
| model--financial-summarization-pegasus--human-centered-summarization | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--Zahwa | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--bibekitani123 | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--federicopascual | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--markt23917 | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--rootacess | Numerics | None | |
...
| model--my_awesome_qa_model--Shushant | Numerics | None | |
...
| model--ner_conll2003--ramybaly | Numerics | None | |
...
| model--pegasus-xsum--google | Numerics | None | |
...
| model--smol_llama-81M-tied--BEE-spoke-data | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-1024-finetuned-squad-seed-42--anas-awadalla | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-16-finetuned-squad-seed-4--anas-awadalla | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-256-finetuned-squad-seed-6--anas-awadalla | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-512-finetuned-squad-seed-10--anas-awadalla | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-64-finetuned-squad-seed-10--anas-awadalla | Numerics | None | |
