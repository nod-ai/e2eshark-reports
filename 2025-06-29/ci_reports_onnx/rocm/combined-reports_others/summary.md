...
| Inference Comparison (PASS) | 2258 | 95.6% | 97.5% |
## Fail Summary
...
| model--bert-base-multilingual-cased-finetuned-squad--timopixel | Numerics | None | |
...
| model--bert-finetuned-ner--carlomax | Numerics | None | |
...
| model--distilbert-base-uncased-finetuned-squad--Walterchamy | Numerics | None | |
...
| model--finetuned-mlm_base--muhtasham | Numerics | None | |
...
| model--ner-from-bert--dsoum | Numerics | None | |
