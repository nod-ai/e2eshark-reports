...
|---|---|---|---|---|---|---|
|migraphx_torchvision__inceptioni32|PASS|progression|6648.7116|20.7076|-6628.004|-99.69%|
|migraphx_torchvision__resnet50i64|PASS|progression|6088.0794|15.7203|-6072.3591|-99.74%|
...
|model--bert-finetuned-ner--carlomax|PASS|Numerics|
...
|model--distilbert-base-uncased-finetuned-squad--Walterchamy|PASS|Numerics|
|model--finetuned-mlm_base--muhtasham|PASS|Numerics|
...
|model--ner-from-bert--dsoum|PASS|Numerics|
|model--pegasus-large-summary-explain--pszemraj|PASS|Numerics|

## 197 Progressions Found:
