...
|---|---|---|---|---|---|---|
|migraphx_torchvision__inceptioni32|PASS|progression|6648.7116|25.8447|-6622.8669|-99.61%|
|migraphx_torchvision__resnet50i64|PASS|progression|6088.0794|19.0874|-6068.992|-99.69%|

## 13 Regressions Found:

|model name|old_status|new_status|
|---|---|---|
|model--bert-finetuned-ner--FatmaZahraZ|PASS|Numerics|
|model--distilbert-base-uncased-finetuned-squad--gokulkarthik|PASS|Numerics|
