...
|---|---|---|---|---|---|---|
|migraphx_torchvision__inceptioni32|PASS|progression|6648.7116|20.5858|-6628.1259|-99.69%|
|migraphx_torchvision__resnet50i64|PASS|progression|6088.0794|15.5968|-6072.4826|-99.74%|

## 19 Regressions Found:

|model name|old_status|new_status|
|---|---|---|
|model--bart-base-few-shot-k-64-finetuned-squad-seed-2--anas-awadalla|PASS|Numerics|
|model--bert-base-multilingual-cased-finetuned-squad--timopixel|PASS|Numerics|
|model--bert-finetuned-ner--DaveMSE|PASS|Numerics|
|model--bert-finetuned-ner--JAS100|PASS|Numerics|
|model--bert-finetuned-ner--awilli|PASS|Numerics|
|model--bert-finetuned-ner--dpuccine|PASS|Numerics|
|model--bert-finetuned-ner--phamvanlinh143|PASS|Numerics|
|model--bert-finetuned-ner3--Ghost1|PASS|Numerics|
|model--bert-finetuned-squad--HKHKHKHK|PASS|Numerics|
|model--bert-finetuned-squad--Raghan|PASS|Numerics|
...
|model--ov-opt-350m-8bit-kv-cache--vuiseng9|PASS|Numerics|
|model--spanbert-base-cased-few-shot-k-256-finetuned-squad-seed-8--anas-awadalla|PASS|Numerics|
