...
| IREE Inference Invocation | 2262 | 98.1% | 99.2% |
| Inference Comparison (PASS) | 2083 | 90.4% | 92.1% |
## Fail Summary
...
| IREE Inference Invocation | 18 | 0.8% |
| Inference Comparison | 179 | 7.8% |
## Test Run Detail
...
| model--Learning-sentiment-analysis-through-imdb-ds--SeNSiTivE | Numerics | None | |
...
| model--bert-base-uncased-few-shot-k-64-finetuned-squad-seed-2--anas-awadalla | Numerics | None | |
...
| model--bert-finetuned-ner--alwaysgetbetter | Numerics | None | |
...
| model--bert-finetuned-ner--bbbbearczx | Numerics | None | |
...
| model--bert-finetuned-ner--huggingface-course | Numerics | None | |
| model--bert-finetuned-ner--ishantja | PASS | None | |
| model--bert-finetuned-ner--jatinshah | Numerics | None | |
| model--bert-finetuned-ner--jdang | PASS | None | |
| model--bert-finetuned-ner--jfarmerphd | Numerics | None | |
...
| model--bert-finetuned-ner--lddczcn | Numerics | None | |
...
| model--bert-finetuned-ner--mldev | Numerics | None | |
...
| model--bert-finetuned-ner--phijve | Numerics | None | |
...
| model--bert-finetuned-ner--the-bee | Numerics | None | |
...
| model--bert-finetuned-squad--Akihiro2 | Numerics | None | |
...
| model--bert-finetuned-squad--Neulvo | Numerics | None | |
...
| model--bert-finetuned-squad--RyanM-R | Numerics | None | |
| model--bert-finetuned-squad--SebastianS | PASS | None | |
| model--bert-finetuned-squad--Shabdansh01 | PASS | None | |
| model--bert-finetuned-squad--Shanny | Numerics | None | |
...
| model--bert-finetuned-squad--andrew234 | Numerics | None | |
...
| model--bert-finetuned-squad--ihfaudsip | Numerics | None | |
...
| model--m2m100_418M-finetuned-kde4-en-to-pt_BR--danhsf | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--Thinkcru | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-vi--huanvo88 | Numerics | None | |
