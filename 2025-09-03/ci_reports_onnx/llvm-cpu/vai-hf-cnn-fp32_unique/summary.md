...
|--|--|--|--|
| Setup | 360 | 99.7% | 99.7% |
| IREE Compilation | 359 | 99.4% | 99.7% |
| Gold Inference | 359 | 99.4% | 100.0% |
| IREE Inference Invocation | 359 | 99.4% | 100.0% |
| Inference Comparison (PASS) | 354 | 98.1% | 98.6% |
## Fail Summary
...
|--|--|--|
| Setup | 1 | 0.3% |
| IREE Compilation | 1 | 0.3% |
| Gold Inference | 0 | 0.0% |
| IREE Inference Invocation | 0 | 0.0% |
| Inference Comparison | 5 | 1.4% |
## Test Run Detail
Test was run with the following arguments:
Namespace(sources=['./e2eshark-reports/ci_reports_llvm-cpu_vai-hf-cnn-fp32-shard1_unique_onnx_json/vai-hf-cnn-fp32-shard1_unique.json', './e2eshark-reports/ci_reports_llvm-cpu_vai-hf-cnn-fp32-shard2_unique_onnx_json/vai-hf-cnn-fp32-shard2_unique.json', './e2eshark-reports/ci_reports_llvm-cpu_vai-hf-cnn-fp32-shard3_unique_onnx_json/vai-hf-cnn-fp32-shard3_unique.json'], output='./e2eshark-reports/vai-hf-cnn-fp32_unique.json', report=True, report_file='./e2eshark-reports/vai-hf-cnn-fp32_unique.md')
