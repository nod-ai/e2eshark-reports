...
|---|---|---|---|---|---|---|
|migraphx_torchvision__inceptioni32|PASS|progression|6648.7116|19.7248|-6628.9869|-99.7%|
|migraphx_torchvision__resnet50i64|PASS|progression|6088.0794|16.3582|-6071.7212|-99.73%|

## 16 Regressions Found:

|model name|old_status|new_status|
|---|---|---|
|model--bart-base-xsum--harouzie|PASS|Numerics|
|model--bert-base-uncased-few-shot-k-128-finetuned-squad-seed-6--anas-awadalla|PASS|Numerics|
|model--bert-finetuned-ner--DavidCollier|PASS|Numerics|
|model--bert-finetuned-ner--Emmanuel|PASS|Numerics|
|model--bert-finetuned-ner--Petros89|PASS|Numerics|
|model--bert-finetuned-ner--mateocolina|PASS|Numerics|
|model--bert-finetuned-ner--romainlhardy|PASS|Numerics|
|model--bert-finetuned-ner_test1--jun-91|PASS|Numerics|
|model--bert-finetuned-squad--courtneypham|PASS|Numerics|
|model--bert-finetuned-squad--robkayinto|PASS|Numerics|
|model--distilbert-base-squad-TFM_1-Question-Answering--JoelVIU|PASS|Numerics|
|model--distilbert-base-uncased-finetuned-squad--Firat|PASS|Numerics|
|model--distilbert-base-uncased-finetuned-squad--huggingliang|PASS|Numerics|
|model--finetuning-sentiment-model-3000-samples--rachtxxy|PASS|Numerics|
