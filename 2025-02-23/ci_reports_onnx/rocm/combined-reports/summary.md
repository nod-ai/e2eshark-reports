...
| Inference Comparison (PASS) | 2048 | 88.9% | 93.1% |
## Fail Summary
...
| model--bert-finetuned-squad--SiraH | Numerics | None | |
...
| model--bert-finetuned-squad--jatinshah | Numerics | None | |
...
| model--distilbert-base-uncased-finetuned-squad-frozen-v2--ericRosello | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--Namig | Numerics | None | |
