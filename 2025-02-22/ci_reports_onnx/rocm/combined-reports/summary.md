...
| Inference Comparison (PASS) | 2043 | 88.6% | 92.9% |
## Fail Summary
...
| model--bert-large-uncased-en-ner--n6ai | Numerics | None | |
| model--bert-large-uncased-finetuned-ner--Jorgeutd | Numerics | None | |
...
| model--expanded-multilingual-ner--gamzenurmadan | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--aneeshmb02 | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--kosec39 | Numerics | None | |
