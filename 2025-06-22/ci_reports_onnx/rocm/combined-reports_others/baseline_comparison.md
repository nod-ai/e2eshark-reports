...
|---|---|---|---|---|---|---|
|migraphx_torchvision__inceptioni32|Numerics|progression|6648.7116|19.1097|-6629.6019|-99.71%|
|migraphx_torchvision__resnet50i64|Numerics|progression|6088.0794|14.8042|-6073.2752|-99.76%|
...
|model--bert-base-cased-finetuned-squad--victorlee071200|PASS|Numerics|
|model--bert-finetuned-ner--AIventurer|PASS|Numerics|
|model--bert-finetuned-ner--Emmanuel|PASS|Numerics|
|model--bert-finetuned-ner--romainlhardy|PASS|Numerics|
|model--bert-finetuned-ner--ysharma|PASS|Numerics|
|model--bert-finetuned-squad--courtneypham|PASS|Numerics|
...
|model--distillbert-base-uncased-fine-tuned-squad--monakth|PASS|Numerics|
...
|model--finetuning-sentiment-model-300-samples--Roshan777|PASS|Numerics|
|model--finetuning-sentiment-model-3000-samples--Jenny01|PASS|Numerics|
|model--finetuning-sentiment-model-3000-samples--JoaquinGianan|PASS|Numerics|
...
|model--pegasus-large-summary-explain--pszemraj|PASS|Numerics|
|model--spanbert-base-cased-few-shot-k-32-finetuned-squad-seed-8--anas-awadalla|PASS|Numerics|
