...
|---|---|---|---|---|---|---|
|migraphx_torchvision__inceptioni32|PASS|progression|6648.7116|25.5767|-6623.1349|-99.62%|
|migraphx_torchvision__resnet50i64|PASS|progression|6088.0794|18.7831|-6069.2963|-99.69%|
...
|model--bert-finetuned-ner--siegelou|PASS|Numerics|
|model--bert-finetuned-ner--vikram15|PASS|Numerics|
|model--bert-finetuned-squad--Akihiro2|PASS|Numerics|
|model--bert-finetuned-squad--JohnXiaXJ|PASS|Numerics|
|model--distilbert-base-uncased-finetuned-squad--pranjalsurana|PASS|Numerics|
...
|model--finetuning-sentiment-model-3000-samples--underoohcf|PASS|Numerics|
...
|model--marian-finetuned-kde4-en-to-fr--lsimon|PASS|Numerics|
