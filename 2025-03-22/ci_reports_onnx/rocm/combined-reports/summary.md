...
| IREE Compilation | 2268 | 98.4% | 98.6% |
| Gold Inference | 2268 | 98.4% | 100.0% |
| IREE Inference Invocation | 2268 | 98.4% | 100.0% |
| Inference Comparison (PASS) | 2101 | 91.1% | 92.6% |
## Fail Summary
...
|--|--|--|
| Setup | 4 | 0.2% |
| IREE Compilation | 33 | 1.4% |
| Gold Inference | 0 | 0.0% |
| IREE Inference Invocation | 0 | 0.0% |
| Inference Comparison | 167 | 7.2% |
## Test Run Detail
...
| swinv2_large_window12to16_192to256.ms_in22k_ft_in1k | Numerics | None | |
...
| model--SAE-distilbert-base-uncased-squad--jgammack | Numerics | None | |
...
| model--bert-finetuned-ner--canLiu | Numerics | None | |
...
| model--bert-finetuned-ner--jperezv | Numerics | None | |
...
| model--bert-finetuned-ner--lyk0013 | Numerics | None | |
| model--bert-finetuned-ner--manoharahuggingface | Numerics | None | |
...
| model--bert-finetuned-ner--vikasaeta | Numerics | None | |
...
| model--bert-finetuned-ner-trainer--marcellodomenis | Numerics | None | |
...
| model--bert-finetuned-squad--MyMild | Numerics | None | |
...
| model--bert-finetuned-squad--Shabdansh01 | Numerics | None | |
...
| model--bert-finetuned-squad--alvintu | Numerics | None | |
...
| model--bert-finetuned-squad--gallyamovi | Numerics | None | |
...
| model--distilbert-base-uncased-finetuned-imdb--sahn | Numerics | None | |
...
| model--m2m100_418M-fr--Jour | Numerics | None | |
...
| model--marian-finetuned-kde4-en-to-fr--Yuch | Numerics | None | |
...
| model--ner-bert-large-cased-pt-lenerbr--pierreguillou | Numerics | None | |
...
| model--sentiment-model-imdb-small-demo--sachinshinde | Numerics | None | |
