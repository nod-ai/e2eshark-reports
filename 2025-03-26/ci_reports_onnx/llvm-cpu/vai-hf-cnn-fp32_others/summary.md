...
| IREE Compilation | 107 | 78.7% | 78.7% |
| Gold Inference | 107 | 78.7% | 100.0% |
| IREE Inference Invocation | 107 | 78.7% | 100.0% |
| Inference Comparison (PASS) | 106 | 77.9% | 99.1% |
## Fail Summary
...
|--|--|--|
| Setup | 0 | 0.0% |
| IREE Compilation | 29 | 21.3% |
| Gold Inference | 0 | 0.0% |
| IREE Inference Invocation | 0 | 0.0% |
| Inference Comparison | 1 | 0.7% |
## Test Run Detail
Test was run with the following arguments:
Namespace(sources=['./e2eshark-reports/ci_reports_llvm-cpu_vai-hf-cnn-fp32-shard1_others_onnx_json/vai-hf-cnn-fp32-shard1_others.json', './e2eshark-reports/ci_reports_llvm-cpu_vai-hf-cnn-fp32-shard2_others_onnx_json/vai-hf-cnn-fp32-shard2_others.json', './e2eshark-reports/ci_reports_llvm-cpu_vai-hf-cnn-fp32-shard3_others_onnx_json/vai-hf-cnn-fp32-shard3_others.json'], output='./e2eshark-reports/vai-hf-cnn-fp32_others.json', report=True, report_file='./e2eshark-reports/vai-hf-cnn-fp32_others.md')
