...
|---|---|---|---|---|---|---|
|migraphx_torchvision__inceptioni32|PASS|progression|6648.7116|28.0127|-6620.6989|-99.58%|
|migraphx_torchvision__resnet50i64|PASS|progression|6088.0794|20.5409|-6067.5385|-99.66%|
...
|model--bart-mofe-rl-xsum--praf-choub|PASS|Numerics|
|model--bert-base-cased_conll2003-sm-first-ner--jordyvl|PASS|Numerics|
|model--bert-base-uncased-few-shot-k-1024-finetuned-squad-seed-4--anas-awadalla|PASS|Numerics|
|model--bert-base-uncased-few-shot-k-1024-finetuned-squad-seed-6--anas-awadalla|PASS|Numerics|
|model--bert-finetuned-ner--Cartinoe5930|PASS|Numerics|
|model--bert-finetuned-ner--ShadowTwin41|PASS|Numerics|
|model--bert-finetuned-squad--vsrinivas|PASS|Numerics|
|model--bert-finetuned-squad1--Ghost1|PASS|Numerics|
