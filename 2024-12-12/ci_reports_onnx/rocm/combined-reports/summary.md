...
| Inference Comparison (PASS) | 2041 | 88.5% | 93.8% |
## Fail Summary
...
| model--marian-finetuned-kde4-en-to-fr--amartyobanerjee | Numerics | None | |
...
| model--spanbert-base-cased-few-shot-k-32-finetuned-squad-seed-10--anas-awadalla | Numerics | None | |
...
| model--vmehlin_distilbert-finetuned-squad--vanme | Numerics | None | |
