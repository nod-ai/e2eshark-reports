...
| IREE Inference Invocation | 2112 | 95.3% | 100.0% |
| Inference Comparison (PASS) | 1950 | 88.0% | 92.3% |
## Fail Summary
...
| model--nbailab-base-ner-scandi--saattrupdan | Numerics | None | |
| model--nd-qna--Trisert | PASS | None | |
| model--ner-bert-base-cased-pt-lenerbr--pierreguillou | Numerics | None | |
...
| model--sberbank-rubert-base-collection3--viktoroo | Numerics | None | |
