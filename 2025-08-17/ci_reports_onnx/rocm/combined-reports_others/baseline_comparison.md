...
|---|---|---|---|---|---|---|
|migraphx_torchvision__inceptioni32|PASS|progression|6648.7116|19.9732|-6628.7385|-99.7%|
|migraphx_torchvision__resnet50i64|PASS|progression|6088.0794|14.6012|-6073.4782|-99.76%|

## 12 Regressions Found:

|model name|old_status|new_status|
|---|---|---|
|model--bart-base-xsum--morenolq|PASS|Numerics|
|model--bert-base-uncased-finetuned-squad--harveyagraphcore|PASS|Numerics|
|model--bert-finetuned-ner--MarcusLee|PASS|Numerics|
|model--bert-finetuned-ner--buehlpa|PASS|Numerics|
|model--bert-finetuned-squad--Raghan|PASS|Numerics|
|model--distilbert-base-uncased-finetuned-squad--bhan|PASS|Numerics|
