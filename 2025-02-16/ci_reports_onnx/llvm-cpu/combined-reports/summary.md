...
| IREE Compilation | 2296 | 99.6% | 99.7% |
| Gold Inference | 2296 | 99.6% | 100.0% |
| IREE Inference Invocation | 2296 | 99.6% | 100.0% |
| Inference Comparison (PASS) | 2055 | 89.2% | 89.5% |
## Fail Summary
...
|--|--|--|
| Setup | 1 | 0.0% |
| IREE Compilation | 8 | 0.3% |
| Gold Inference | 0 | 0.0% |
| IREE Inference Invocation | 0 | 0.0% |
| Inference Comparison | 241 | 10.5% |
## Test Run Detail
...
| model--125M_GPTneo_reward_base--Myashka | Numerics | None | |
...
| model--PT_GPTNEO125_ATG--xhyi | Numerics | None | |
...
| model--TinyStories-1Layer-21M--roneneldan | Numerics | None | |
| model--TinyStories-1M--roneneldan | Numerics | None | |
| model--TinyStories-2Layers-33M--roneneldan | Numerics | None | |
| model--TinyStories-33M--roneneldan | Numerics | None | |
...
| model--cm_code_clippy--ncoop57 | Numerics | None | |
| model--codegen-350M-mono--Salesforce | Numerics | None | |
| model--codegen-350M-mono-4bit-qlora--iamtarun | Numerics | None | |
| model--deberta-italian-question-answering--osiria | Numerics | None | |
| model--deberta-v3-base-qa-en--LLukas22 | Numerics | None | |
| model--deberta-v3-base-squad2--deepset | Numerics | None | |
| model--deberta-v3-base-squad2--navteca | Numerics | None | |
| model--deberta-v3-base__sst2__all-train--SetFit | Numerics | None | |
| model--deberta-v3-large-squad2--deepset | Numerics | None | |
| model--deberta-v3-large-squad2--sjrhuschlee | Numerics | None | |
| model--deberta-v3-xsmall-squad2--nlpconnect | Numerics | None | |
| model--deberta_squadnewsqa--sophiebottani | Numerics | None | |
...
| model--distilgpt2-sd--aabidk | Numerics | None | |
| model--distilgpt2-stable-diffusion--FredZhang7 | Numerics | None | |
| model--distilgpt2-stable-diffusion-v2--FredZhang7 | Numerics | None | |
| model--distilgpt2-wikitext2--Intel | Numerics | None | |
...
| model--finetuned_distilgpt2_sst2_negation0.0001_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.001_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.001_pretrainedTrue_epochs3--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.01_pretrainedFalse_epochs10--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.01_pretrainedFalse_epochs3--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.01_pretrainedFalse_epochs6--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.01_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.0_pretrainedFalse_epochs0--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.0_pretrainedTrue--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.0_pretrainedTrue_epochs0--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.1_pretrainedFalse_epochs10--jhaochenz | Numerics | None | |
| model--finetuned_distilgpt2_sst2_negation0.1_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.0001_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.001_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.001_pretrainedTrue_epochs2--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.001_pretrainedTrue_epochs3--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.01--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.01_pretrainedFalse_epochs10--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.01_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.05--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.0_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.1_pretrainedFalse_epochs10--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.1_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.2--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.5--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.5_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.8--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-large_sst2_negation0.8_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.0001_pretrainedTrue--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.0001_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.0001_pretrainedTrue_epochs3--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.0005_pretrainedTrue--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.001_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.001_pretrainedTrue_epochs3--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.01--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.01_pretrainedFalse_epochs10--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.01_pretrainedFalse_epochs3--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.01_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.05--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.05_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.0_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.0_pretrainedFalse_epochs30--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.1_pretrainedFalse_epochs10--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.1_pretrainedTrue_epochs1--jhaochenz | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.2--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.2_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.5--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.5_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.8--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2-medium_sst2_negation0.8_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.0001_pretrainedFalse_epochs1--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.0001_pretrainedTrue--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.0005_pretrainedTrue--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.001_pretrainedTrue--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.05--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.0_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.2_pretrainedFalse--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.5--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.8--yuhuizhang | Numerics | None | |
| model--finetuned_gpt2_sst2_negation0.8_pretrainedFalse--yuhuizhang | Numerics | None | |
...
| model--gpt2--openai-community | Numerics | None | |
| model--gpt2-650k-stable-diffusion-prompt-generator--Ar4ikov | Numerics | None | |
| model--gpt2-alpaca-gpt4--vicgalle | Numerics | None | |
| model--gpt2-finetuning-sentiment-model-3000-samples--LYTinn | Numerics | None | |
| model--gpt2-imdb-sentiment-classifier--mnoukhov | Numerics | None | |
| model--gpt2-wikitext103--himanshubeniwal | Numerics | None | |
| model--gpt2_wikitext37_7k_pretrained_iphone_1e4--himanshubeniwal | Numerics | None | |
| model--hebert-finetuned-hebrew-squad--tdklab | PASS | None | |
| model--hebrew_poetry-gpt_neo-small--Norod78 | Numerics | None | |
...
| model--mdeberta-v3-base-squad2--sjrhuschlee | Numerics | None | |
...
| model--megatron-gpt2-345m--robowaifudev | Numerics | None | |
| model--mi-modelo-bacan-test--fmesa | PASS | None | |
| model--microsoft-deberta-v3-large_ner_conll2003--Gladiator | Numerics | None | |
...
| model--neo-125m-wills-loss-function-by-tr--Jellywibble | Numerics | None | |
...
| model--outputs--ankitkupadhyay | Numerics | None | |
| model--ov-gpt2-fp32-kv-cache--vuiseng9 | Numerics | None | |
...
| model--pegasus-large-booksum--cnicu | Numerics | None | |
...
| model--reward-model-deberta-v3-large-v2--OpenAssistant | Numerics | None | |
...
| model--tiny-random-GPTNeoForSequenceClassification--hf-tiny-model-private | Numerics | None | |
...
| model--wikitext-ds--mahmoudNG | Numerics | None | |
