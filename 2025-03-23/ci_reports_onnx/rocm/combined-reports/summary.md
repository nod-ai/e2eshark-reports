...
| Inference Comparison (PASS) | 2104 | 91.3% | 92.8% |
## Fail Summary
...
| model--BERT_summary--Shobhank-iiitdwd | Numerics | None | |
...
| model--bart-base-few-shot-k-512-finetuned-squad-seed-4--anas-awadalla | Numerics | None | |
...
| model--bart-large-finetuned-squadv1--valhalla | Numerics | None | |
...
| model--bert-base-uncased-few-shot-k-128-finetuned-squad-seed-2--anas-awadalla | Numerics | None | |
...
| model--bert-finetuned-ner--azuresonance | Numerics | None | |
...
| model--bert-finetuned-ner--chandrasutrisnotjhong | Numerics | None | |
...
| model--bert-finetuned-ner--yinxiaoz | Numerics | None | |
...
| model--bert-finetuned-squad--lewtun | Numerics | None | |
...
| model--bert-finetuned-squad--rghosh8 | Numerics | None | |
...
| model--bert-finetuned-squad--tmgondal | Numerics | None | |
...
| model--bert-qa-en--srcocotero | Numerics | None | |
| model--biobert-base-cased-v1.2-bc2gm-ner--chintagunta85 | PASS | None | |
| model--biobert-base-cased-v1.2_ncbi_disease-softmax-labelall-ner--jordyvl | Numerics | None | |
...
| model--finetuning-sentiment-model-3000-samples--rh-jayson | Numerics | None | |
